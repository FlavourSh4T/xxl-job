# XXL-JOB 兼容旧版Executor

## Introduction

* 某些旧项目使用了旧版XXL-JOB，但是调度任务管理中心需要升级
* 某些使用JDK1.8以下的项目无法支持新版本的XXL-JOB

针对上述问题，本项目对XXL-JOB源代码进行改造，在XXL-JOB 2.4.0版本的基础上兼容XXL-JOB 2.1.0版本的执行器进行注册和调度。

## Features

* 兼容使用 xxl-job-core-2.1.0 的执行器的注册、调度、查看日志等各项功能

## XXL-JOB Official Documentation
